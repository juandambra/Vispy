...
from examples.basics.gloo.midi_monitor import MidiMonitor
...
class Canvas(app.Canvas):
    def __init__(self):
        ...
        #self._timer = app.Timer('auto', connect=None, start=True)   #Siempre poner un timer asi se pone bien la funcion update!!
